...
if (input.files && input.files[0]) {
  ...
  reader.onload = function(e) {
    ...
    imageFoo.src = e.target.result;
    imageFoo.width = '100';
    imageFoo.height = '100';
    file_display_area.html('');
    file_display_area.append(imageFoo);
     
    file_display_area.closest('.cropme').next('input').val(e.target.result);
  }
  ...
  reader.readAsDataURL(input.files[0]);
        ...
        function preview() {
            ...
            file_display_area.closest('.cropme').parent().addClass('kuch_bhi');
            file_display_area.closest('.cropme').next('input').val(dataUrl);
