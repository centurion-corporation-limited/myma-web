...
return
    ...
    [
         ...
         */
        'siteId' => 'ga:175669054',//env('ANALYTICS_SITE_ID'),
         ...
         */
        'clientId' => '185969502127-1eqt1ee36btu64sfduicbk5rusfcfl9r.apps.googleusercontent.com',//env('ANALYTICS_CLIENT_ID'),
         ...
         */
        'serviceEmail' => 'myma-1520248374001@appspot.gserviceaccount.com',//env('ANALYTICS_SERVICE_EMAIL'),

        /*
         * You need to download a p12-certifciate from the Google API console
         * Be sure to store this file in a secure location.
         */
        'certificatePath' => storage_path('myma-1520248374001-99fbaaca6193.p12'),
