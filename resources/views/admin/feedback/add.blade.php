          ...
          <div class="x_content">
            ...
            <form id="demo-form2" action="{{ route('admin.advertisement.add') }}" method="POST" enctype="multipart/form-data"  data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-9 col-xs-12">
                  <input id="birthday" name="start" class="date-picker form-control" required="required" type="text">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-9 col-xs-12">
                  <input id="birthday" name="end" class="date-picker form-control" required="required" type="text">
                </div>
              </div>
