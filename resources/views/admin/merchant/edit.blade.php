...
@section('content')
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Edit Physical Merchant</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <br />
            <form id="demo-form2" action="{{ route('admin.merchant.edit', encrypt($item->id)) }}" method="POST" enctype="multipart/form-data"  data-parsley-validate class="form-horizontal form-label-left">
              {{ csrf_field() }}

              <div class="form-group">
                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="type">Managed By<span class="required">*</span></label>
                <div class="col-md-6 col-sm-10 col-xs-12">
                    {!!Form::select('user_id', $users, $item->user_id, ['class' => 'form-control'])!!}
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10 col-xs-12">
                  <input type="text" id="title" readonly name="merchant_name" value="{{ old('merchant_name', $item->merchant_name) }}" class="form-control">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10 col-xs-12">
                    {!!Form::select('location', $dormitories, $item->location, ['class' => 'form-control'])!!}
                </div>
              </div>

              <!-- <div class="form-group">
                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="merchant_share">Merchant Share (%)<span class="required">*</span></label>
                <div class="col-md-6 col-sm-10 col-xs-12">
              ...
              <div class="form-group">
                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="v_cost">V Cost Involved</label>
                <div class="col-md-6 col-sm-10 col-xs-12">
                    Yes
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10 col-xs-12">
                    <input type="text" id="v_cost_type" name="v_cost_type" value="{{ old('v_cost_type', $item->v_cost_type) }}" class="form-control">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10 col-xs-12">
                    <input type="text" id="merchant_address_1" maxlength="35" name="merchant_address_1" value="{{ old('merchant_address_1', $item->merchant_address_1) }}" class="form-control">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10 col-xs-12">
                    <input type="text" id="merchant_address_2" maxlength="35" name="merchant_address_2" value="{{ old('merchant_address_2', $item->merchant_address_2) }}" class="form-control">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10 col-xs-12">
                    <input type="text" id="merchant_address_3" maxlength="35" name="merchant_address_3" value="{{ old('merchant_address_3', $item->merchant_address_3) }}" class="form-control">
                </div>
              </div>
