    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <form id="demo-form2" action="{{ route('admin.category.edit', encrypt($item->id)) }}" method="POST" enctype="multipart/form-data"  data-parsley-validate class="form-horizontal form-label-left">
              {{ csrf_field() }}

              <div class="form-group">
                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="type">Type <span class="required">*</span></label>
                <div class="col-md-6 col-sm-10 col-xs-12">
                    {!!Form::select('type_id', $types, $item->type_id, ['class' => 'form-control'])!!}
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10 col-xs-12">
                  <input type="text" id="name_bn" name="name_bn" value="{{ old('name_bn', $item->name_bn) }}" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10 col-xs-12">
                  <input type="text" id="name_mn" name="name_mn" value="{{ old('name_mn', $item->name_mn) }}" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10 col-xs-12">
                  <input type="text" id="name_ta" name="name_ta" value="{{ old('name_ta', $item->name_ta) }}" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              <div class="form-group">
                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="name_th">Name(Thai)</label>
                <div class="col-md-6 col-sm-10 col-xs-12">
                  <input type="text" id="name_th" name="name_th" value="{{ old('name_th', $item->name_th) }}" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
