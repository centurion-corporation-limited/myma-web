    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <br />
            <form id="demo-form2" action="{{ route('admin.spuul.plan.add') }}" method="POST" enctype="multipart/form-data"  data-parsley-validate class="form-horizontal form-label-left">
              {{ csrf_field() }}
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10 col-xs-12">
                  <select id="role" class="form-control" name="type">
                      <option value="1" @if(old('type') == '1') selected="selected" @endif>Monthly</option>
                      <option value="2" @if(old('type') == '2') selected="selected" @endif>Yearly</option>
                  </select>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10 col-xs-12">
                  <input type="text" id="price" name="price" placeholder="20" value="{{ old('price') }}" class="form-control">
                </div>
              </div>
              ...
              <!-- <div class="form-group impression_div">
                  ...
                  <div class="col-md-6 col-sm-10 col-xs-12">
                      <select id="status" class="form-control" name="status">
                          <option value="1" @if(old('type') == '1') selected="selected" @endif>Active</option>
                          <option value="0" @if(old('type') == '0') selected="selected" @endif>Inactive</option>
                      </select>
                  </div>
              </div> -->
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10 col-xs-12">
                  <select id="list_order" class="form-control" name="list_order">
                      <option value="1" @if(old('list_order') == '1') selected="selected" @endif>1</option>
                      <option value="2" @if(old('list_order') == '2') selected="selected" @endif>2</option>
                  </select>
                </div>
              </div>
