...
@section('content')
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>ISO Delight Share</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <br />
            <form id="demo-form2" action="{{ route('admin.share.update', encrypt($merchant_id)) }}" method="POST" enctype="multipart/form-data"  data-parsley-validate class="form-horizontal form-label-left">
              {{ csrf_field() }}

              <div class="form-group">
                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="merchant_share">WLC Subscription Share <span class="required">*</span></label>
                <div class="col-md-6 col-sm-10 col-xs-12">
                  <input type="text" id="title" name="merchant_share" value="{{ old('merchant_share', $item->merchant_share) }}" class="form-control">
                </div>
              </div>
            
              <div class="form-group">
                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="naanstap_share">Naanstap Subscription Share <span class="required">*</span></label>
                <div class="col-md-6 col-sm-10 col-xs-12">
                  <input type="text" id="title" name="naanstap_share" value="{{ old('naanstap_share', $item->naanstap_share) }}" required class="form-control">
                </div>
              </div>

              <div class="form-group">
                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="subscription_limit">Subscription limit after which subscription will be chargeable<span class="required">*</span></label>
                <div class="col-md-6 col-sm-10 col-xs-12">
                  <input type="text" id="title" name="subscription_limit" value="{{ old('subscription_limit', $item->subscription_limit) }}" required class="form-control">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10 col-xs-12">
                  <input type="text" id="title" name="myma_transaction_share" value="{{ old('myma_transaction_share', $item->myma_transaction_share) }}" class="form-control">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10 col-xs-12">
                  <input type="text" id="title" name="revenue_model" value="{{ old('revenue_model', $item->revenue_model) }}" class="form-control">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10 col-xs-12">
                    <input type="text" id="merchant_address_1" name="merchant_address_1" value="{{ old('merchant_address_1', $item->merchant_address_1) }}" required class="form-control">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10 col-xs-12">
                    <input type="text" id="bank_name" name="bank_name" value="{{ old('bank_name', $item->bank_name) }}" required class="form-control">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10 col-xs-12">
                    <input type="text" id="bank_address" name="bank_address" value="{{ old('bank_address', $item->bank_address) }}" required class="form-control">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10 col-xs-12">
                    <input type="text" id="bank_country" name="bank_country" minlength="2" maxlength="2" value="{{ old('bank_country', $item->bank_country) }}" required class="form-control">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10 col-xs-12">
                    <input type="text" id="account_number" name="account_number" value="{{ old('account_number', $item->account_number) }}" required class="form-control">
                </div>
              </div>
