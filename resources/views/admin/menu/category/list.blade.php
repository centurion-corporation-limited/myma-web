...
<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content x_content_form">
                    <!--<form action="{{ route('admin.menu.category.list') }}" method="GET" class="form-inline">-->
                    <!--      <div class="form-group">-->
                    <!--          <input type="text" placeholder="Name" name="name" value="{{ Request::input('name') }}" class="form-control input-small">-->
                    <!--      </div>-->

                    <!--      <button class="btn btn-success" type="submit">Search</button>-->
                    <!--      <a href="{{ route('admin.menu.category.list') }}" class="btn btn-success">Reset</a>-->
                    <!--</form>-->
                    <table id="datatable-responsivee" class="table table-striped table-bordered dt-responsive nowrap foo_table" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>{{ $item->order }}</td>
                          <td>
                            <a href="{{ route('admin.menu.category.edit', encrypt($item->id)) }}"><i class="fa fa-2x fa-edit"></i></a>
