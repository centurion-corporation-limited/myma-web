  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content x_content_form">
                      <form action="{{ route('admin.menu.dormitory') }}" method="GET" class="form-inline">
                          <div class="row flex-row transaction-form">
                            <label class="control-label" for="">Dormitory</label>
                            <div class="input-group">
                              <select class="user_list input-group" name="dormitory_id">
                              </select>
                            ...
                            <div class="row flex-row button-tran">
                              ...
                              <a href="{{ route('admin.menu.dormitory') }}" class="btn btn-success">Reset</a>
                            </div>
                        </form>
      </div>
    </div>
...
$(".user_list").select2({
  ajax: {
    url: "{{ route('admin.get.app_dormitory') }}",
    dataType: 'json',
    delay: 250,
