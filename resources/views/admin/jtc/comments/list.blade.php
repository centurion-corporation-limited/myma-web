...
<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content x_content_form">
                    <form action="{{ route('admin.jtc.comments.list') }}" method="GET" class="form-inline">
                          ...
                          <a href="{{ route('admin.jtc.comments.list', ['menu_type' => request('menu_type')]) }}" class="btn btn-success">Reset</a>
                    </form>
                    <table id="datatable-responsivee" class="table table-striped table-bordered dt-responsive nowrap table-hover display foo_table" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a data-toggle="tooltip" data-placement="top" title="Click to edit the content." href="{{ route('admin.jtc.comments.edit', encrypt($item->id)) }}"><i class="fa fa-2x fa-edit"></i></a>
                            <a data-toggle="tooltip" data-placement="top" title="Click to delete the content." href="{{ route('admin.jtc.comments.delete', ['id' => $item->id, '_token' => csrf_token()]) }}" data-message="Are you sure about deleting this?" class="post-deletee"><i class="fa fa-2x fa-trash-o"></i></a>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
