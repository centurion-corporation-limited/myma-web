                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a href="{{ route('admin.category.add') }}">Add Package</a>
                      </li>
                    </ul>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="{{ route('admin.category.delete', ['id' => encrypt($item->id), '_token' => csrf_token()]) }}" data-message="Are you sure about deleting this?" class="post-deletee"><i class="fa fa-2x fa-trash-o"></i></a>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
