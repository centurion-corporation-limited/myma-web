    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <form id="demo-form2" action="{{ route('admin.services.edit', encrypt($item->id) ) }}" method="POST" enctype="multipart/form-data"  data-parsley-validate class="form-horizontal form-label-left colord-form">
              {{ csrf_field() }}
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10 col-xs-12">
                  ...
                  <a href="{{ route('admin.services.edit', encrypt($item->id)) }}" class="btn btn-success">Edit</a>
                </div>
              </div>
