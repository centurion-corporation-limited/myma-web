...
.cropmee{
    ...
    margin-bottom: 5px;
    margin-right: 5px;
    background-image: url({{ static_file('/js/plugins/cropper/images/UploadLight.png') }});
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <br />
            <form id="demo-form2" action="{{ route('admin.services.edit', encrypt($item->id) ) }}" method="POST" enctype="multipart/form-data"  data-parsley-validate class="form-horizontal form-label-left">
              {{ csrf_field() }}
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10 col-xs-12">
                  <select id="type" class="form-control" name="type">
                      <!-- <option value="mom" @if(old('type', $item->type) == 'mom') selected @endif>MOM</option> -->
                      <option value="event-news" @if(old('type', $item->type) == 'event-news') selected @endif>Event & attraction</option>
                      <!-- <option value="custom1" @if(old('type', $item->type) == 'custom1') selected @endif>Custom1</option> -->
                      <!-- <option value="custmo2" @if(old('type', $item->type) == 'custom2') selected @endif>Custom2</option> -->
                      <option value="custom3" @if(old('type', $item->type) == 'custom3') selected @endif>Embassy</option>
                  </select>
                </div>
              </div>
              ...
              <div class="form-group hide dorm">
                ...
                <div class="col-md-6 col-sm-10 col-xs-12">
                    {!!Form::select('dormitory_id', $dorm, $item->dormitory_id, ['class' => 'form-control'])!!}
                </div>
              </div>
                ...
                <div class="col-md-6 col-sm-10 col-xs-12">
                  <div class="colapsImg">
                    ...
                    <div class="orgImg">
                      ...
                      @else
                        <div class="cropmee" style="width: 640px; height: 410px;">
                            {{--<img src="{{ static_file('/js/plugins/cropper/images/UploadLight.png') }}" style="max-width: inherit;" />    --}}
                        </div>
