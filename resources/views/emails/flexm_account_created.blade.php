...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	...
	*/
	...
	@media only screen and (min-width:768px){
		...
		.mcnImageCardTopImageContent,.mcnCaptionBlockInner .mcnCaptionTopContent:last-child .mcnTextContent{padding-top:18px !important;}
                    ...
                    <td align="center" valign="top" id="bodyCell">
                      ...
                      <td valign="top" class="bodyContainer">
                    							...
                    							<tbody>
	                            					...
	                            					<p><strong>Welcome to your MyMA account !</strong></p><br>
																				Your User Login ID is :	{{ $id or '' }}<br>
																				Password is : {{ $pass or '' }}<br><br>
																				Please login to your MyMA mobile app to enjoy many features and benefits !<br>
																				See <a href="{{ url('flexm/faq') }}" target="_blank" >FAQs</a> and Top-up Wallet Step-by-Step guide <a target="_blank" href="{{ url('flexm/guide') }}">Here</a>.<br><br>

																				Please visit our MyMA website (<a href="https://www.myma.app" target="_blank">https://www.myma.app</a>) and "Like" to support our <br>
																				MyMA Facebook page & Instagram and see our MyMA events photos & videos !<br><br>

																				<a href="https://www.facebook.com/mymaapp" target="_blank">https://www.facebook.com/mymaapp</a><br>
																				<a href="https://www.instagram.com/mymaapp" target="_blank">https://www.instagram.com/mymaapp</a>
                        							</td>
                    							  </tr>
                									</tbody>
																</table>
            ...
            <td valign="top" class="mcnTextBlockInner" style="padding-top:9px;">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
<strong>WLC FACILITIES SERVICES PTE LTD</strong>
<br>
45 Ubi Road 1, #05-01, Singapore 408696<br>
Customer Service Helpline: (65) 6740 5834, 6740 5883 <br>
Customer Service Email: enquiry@myma.app<br>
