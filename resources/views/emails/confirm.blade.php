...
You account is created as {{ $type }} user.
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Helvetica; font-size: 18px; padding: 18px;">
                                <a class="mcnButton " title="Activate my Account" href="{{ route('confirm', $email_confirm_key) }}" target="_self" style="font-weight: bold;letter-spacing: -0.5px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Confirm my Email</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
