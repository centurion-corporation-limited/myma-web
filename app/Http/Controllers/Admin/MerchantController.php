...
class MerchantController extends Controller
{
    ...
    public function postAdd(AddMerchantRequest $request)
    {
        ...
        'frequency', 'start_date', 'revenue_model', 'v_cost_type', 'product_type', 'user_id', 'merchant_address_1',
        'merchant_address_2', 'merchant_address_3', 'gst', 'gst_number');
    ...
    public function postEdit($id, EditMerchantRequest $request)
    {
        ...
        $data = $request->only('user_id', 'location', 'merchant_share', 'myma_transaction_share', 'frequency',
        'revenue_model', 'v_cost_type', 'product_type', 'merchant_address_1', 'merchant_address_2',
        'merchant_address_3', 'gst', 'gst_number');
