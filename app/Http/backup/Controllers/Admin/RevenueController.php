...
class RevenueController extends Controller
{
  ...
  public function exportRevenueReport(Request $request)
  {
      ...
      if(count($items)){
          ...
          'Vendor QTY', 'Vendor Sale', 'Gross revenue earned', 'Cost sharing charged', 'Wallet Txn fee Earn', 'Wallet cost charged',
          'Net revenue earned', 'Payback to vendor', 'Revenue Model');
      }
