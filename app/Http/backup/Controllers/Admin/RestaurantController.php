...
class RestaurantController extends Controller
{
    public function getList(Request $request)
    {
      ...
      return view('admin.food.restaurant.list', compact('items', 'auth_user', 'paginate_data'));
    }
    ...
    public function getCategoryList(Request $request)
    {
      ...
      return view('admin.food.category.list', compact('items', 'auth_user', 'paginate_data'));
    }
    ...
    public function getCourseList(Request $request)
    {
      ...
      return view('admin.food.course.list', compact('items', 'auth_user', 'paginate_data'));
    }
