...
class FoodController extends Controller
{
    public function getList(Request $request)
    {
      ...
      return view('admin.food.menu.list', compact('items', 'auth_user', 'paginate_data','merchants', 'flag'));
    }
    ...
    public function getAdd()
    {
        ...
        return view('admin.food.menu.add', compact('auth_user', 'users', 'courses', 'category', 'single_restra', 'catering_restra', 'flag'));
    }
    ...
    public function getEdit($id, Request $request)
    {
        ...
        if($foodmerchant->user->hasRole('restaurant-owner-catering')){
          $merchant = Merchant::find(13);

          $wlc_share = $merchant->merchant_share != ""?$merchant->merchant_share:'3.75';
          $naanstap_share_per = $foodmerchant->naanstap_share != ""?$foodmerchant->naanstap_share:'1.25';
          ...
          $selling_price = ((($price+$naanstap_share)/(1-($wlc_share_per/100)-($flexm_per/100))));
        ...
        return view('admin.food.menu.edit', compact('item', 'users', 'courses', 'category', 'single_restra', 'catering_restra', 'html', 'flag', 'restaurant_id'));
    }
          ...
          if($item){
            ...
            if($item->user->hasRole('restaurant-owner-catering')){
              ...
              if($type == 'cost'){
                ...
                $cost_price = $actual_price-$flexm_share-$wlc_share;
    ...
    public function getPackageList(Request $request)
    {
      ...
      return view('admin.food.menu.package.list', compact('items', 'auth_user', 'paginate_data'));
    }
