...
class ProfileController extends Controller
{
    ...
    public function home(Request $request)
    {
        ...
        if($user->profile && $user->profile->fin_no != ''){
        ...
        try{
          ...
          if($user->type == 'free'){
              $menu = Menu::where('access', 'free')->limit(4)->pluck('id')->toArray();
          }else{
          ...
          $menus = Menu::whereIn('id',$menu)->select('id','name','name_bn','name_ta','name_mn', 'name_th', 'slug')->get()->toArray();
