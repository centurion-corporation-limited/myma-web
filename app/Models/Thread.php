...
class Thread extends Eloquent
{
     ...
     * @var array
     */
    protected $fillable = ['subject', 'campaign_applied_id', 'creator_id'];
	...
	/**
     * Returns avatr for the first participant
     *
     * @return avatar
     */
    public static function getAvatar($thread, $currentUserId)
    {
		$avatar = '';
		foreach($thread->participants as $participant){
			...
			if(isset($participant->user->profile->avatar)){
    ...
    public function campaign_applied()
    {
        return $this->belongsTo(CampaignApply::class, 'project_key');
    }
